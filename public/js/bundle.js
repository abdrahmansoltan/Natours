...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJkZWxyYWhtYW5zb2x0YW4iLCJhIjoiY2xmamhubDF6MDEwZDNybXRxYjdmYXh4NyJ9.JOsaOkjoDzZzF97AXM21Og';
  var map = new mapboxgl.Map({
    container: 'map',
    // element ID to replace
    style: 'mapbox://styles/abdelrahmansoltan/clfjhqpe9003y01qogienu6y1',
    scrollZoom: false
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44947" + '/');
